          ...
          <div className="bg-[#0A0A0A] h-[100vh]">
            ...
            <div className="flex justify-center items-center flex-col h-[90vh]">
              ...
              <div className="sm:ml-10 mt-10 flex flex-col sm:flex-row">
                ...
                <a href="/" onClick={props.apply} className="cursor-pointer pl-5 pr-5 pt-2 pb-2 rounded-md active:bg-white bg-red-500 text-white font-bold font-alkatra active:text-black">apply</a>
              </div>
            </div>
          </div>
      </>
