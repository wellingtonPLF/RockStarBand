...
Using the Data Proxy (connection URL starting with protocol ${(0, import_colors.green)(
  "prisma://"
)}) is not supported for this CLI command ${(0, import_colors.green)(`prisma ${command}`)} yet. ${command === "studio" ? "" : "Please use a direct connection to your database via the datasource 'directUrl' setting."}
